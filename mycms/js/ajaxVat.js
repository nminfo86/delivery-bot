...
$(document).ready(function () {
    ...
    function fillObject(id) {
        $.ajax({
            ...
            jsonp: false,
            dataType: dataType,
            data: "function=getVatById&id=" + id,
            beforeSend: function () {
                $("#loadingImage").removeClass("d-none");
            },
            success: function (data) {
                if (data.state === "f") {
                    ...
                    objectForm.find("#vat").val(data[0].vat);
                    objectForm.find("#rate").val(data[0].rate);
    ...
    function createObject() {
        ...
        $.ajax({
            ...
            jsonp: false,
            dataType: dataType,
            data: "function=createVat&" + objectForm.serialize(),
            beforeSend: function () {
                $("#loadingImage").removeClass("d-none");
            },
            success: function (data) {
                if (data.state === "f") {
                    ...
                    showAlertSuccess(objectAlert, JsTranslations.msg_object_added.replace("{object}", data[0].vat));
                    objectForm.find("#id").val(data[0].id);
                    search();
                }
                $("#loadingImage").addClass("d-none");
    ...
    function updateObject(id) {
        $.ajax({
            ...
            jsonp: false,
            dataType: dataType,
            data: "function=updateVat&" + objectForm.serialize(),
            beforeSend: function () {
                $("#loadingImage").removeClass("d-none");
            },
            success: function (data) {
                if (data.state === "f") {
                    ...
                    showAlertSuccess(objectAlert, JsTranslations.msg_object_updated.replace("{object}", data[0].vat));
                    search();
